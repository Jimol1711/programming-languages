...
(define period45 (mcons 4 (mcons 5 'dummy)))
(set-mcdr! period45 (mcons 5 period45))
(define n145 (mcons 1 period45))

(define (mtake m n)
  (cond
    [(= n 0) '()]
    [else (cons (mcar m) (mtake (mcdr m) (- n 1)))]))
...
(define fact0 '{with {fact {fun {n} {if0 n 1 {* n {fact {- n 1}}}}}} {fact 0}})
